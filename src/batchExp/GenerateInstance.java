...
public class GenerateInstance {
	public static String rootPath = "batch\\";
	
	public static void generate(CtrlInfo ct) throws IOException {
		String strbuff;
		String mapPath = new String(rootPath + "AntMap\\" + ct.mapName + ".txt");
		BufferedReader data = new BufferedReader(new FileReader(mapPath));
